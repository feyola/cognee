...
RUN --mount=type=cache,target=/root/.cache/uv \
    uv sync --extra api --extra postgres --extra llama-index --extra ollama --extra anthropic --frozen --no-install-project --no-dev --no-editable
...
COPY ./kuzu /app/kuzu
RUN --mount=type=cache,target=/root/.cache/uv \
    uv sync --extra api --extra postgres --extra llama-index --extra ollama --extra anthropic --frozen --no-dev --no-editable
