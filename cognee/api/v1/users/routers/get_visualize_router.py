...
from cognee.modules.users.methods.get_authenticated_websocket_user import _read_handshake_user
...
async def get_visualize_websocket_user(websocket: WebSocket) -> Optional[User]:
...
def get_visualize_router() -> APIRouter:
    ...
    async def subscribe_to_dataset_updates(
        ...
        user: Optional[User] = Depends(get_visualize_websocket_user),
    ):
        """
