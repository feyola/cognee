...
from cognee.api.v1.users.routers.get_visualize_router import get_visualize_websocket_user
...
def app(monkeypatch):
    ...
    application.dependency_overrides[get_visualize_websocket_user] = lambda: SimpleNamespace(
...
def test_an_unauthenticated_connection_is_closed_with_1008(app):
    app.dependency_overrides[get_visualize_websocket_user] = lambda: None
